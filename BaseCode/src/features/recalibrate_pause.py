...
class VideoFunctions:
    ...
    @staticmethod
    def run_pause_calibration(output_path: str, thresholds=None) -> None:
        """Recalibra pause_threshold usando las trayectorias ya guardadas en BD"""
        print("\nRecalibrando pause_threshold...")
        cmd = [
            "python",
            "src/features/recalibrate_pause_threshold.py",
            "--output", output_path,
        ]
        if thresholds:
